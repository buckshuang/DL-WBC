...
base_model = convnext.ConvNeXtTiny(input_shape=(240, 240, 3),num_classes=0)
...
callbacks = [keras.callbacks.ModelCheckpoint("ConvNext_{epoch:004d}.h5",monitor='val_categorical_accuracy',verbose=1,save_best_only=True,mode='max'),]
...
np.save('ConvNext.npy',history.history)
