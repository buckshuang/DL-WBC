...
base_model = resnest.ResNest50(input_shape=(240, 240, 3),num_classes=0)
...
callbacks = [keras.callbacks.ModelCheckpoint("ResNest_{epoch:04d}.h5",monitor='val_categorical_accuracy',verbose=1,save_best_only=True,mode='max'),]
...
np.save('ResNeSt.npy',history.history)
