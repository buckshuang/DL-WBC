...
base_model = resnet_family.RegNetZD8(input_shape=(240, 240, 3),num_classes=0)
...
x = keras.layers.Dense(896,activation = "relu")(x)
x = keras.layers.Dropout(0.3)(x)
#x = keras.layers.Dense(448,activation = "relu")(x)
#x = keras.layers.Dropout(0.3)(x)
...
epochs = 100
base_model.trainable = True
callbacks = [keras.callbacks.ModelCheckpoint("RegNetZD_{epoch:04d}.h5",monitor='val_categorical_accuracy',verbose=1,save_best_only=True,mode='max'),]
...
np.save('RegNetZD.npy',history.history)
