...
callbacks = [keras.callbacks.ModelCheckpoint("InceptionV3_{epoch:04d}.h5",monitor='val_categorical_accuracy',verbose=1,save_best_only=True,mode='max'),]
...
np.save('InceptionV3.npy',history.history)
