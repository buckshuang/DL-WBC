...
base_model = resnet_family.RegNetZC16(input_shape=(240, 240, 3),num_classes=0)
...
base_model.trainable = True
callbacks = [keras.callbacks.ModelCheckpoint("RegNetZC_{epoch:04d}.h5",monitor='val_categorical_accuracy',verbose=1,save_best_only=True,mode='max'),]
...
np.save('RegNetZC.npy',history.history)
